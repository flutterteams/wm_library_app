          ...
          builder: (context) => new AlertDialog(
                  ...
                  actions: <Widget>[
                    ...
                    new FlatButton(
                      ...
                      onPressed: () {
                        _saveData(
                            _getStore().state.person.id.toString(),
                            _getStore().state.person.email.toString(),
                            _getStore().state.person.status.toString());
                        Navigator.of(context).pop();
                      },
                    )
                  ]));
                          ...
                          new Expanded(
                            child: new TextField(
                              controller: new TextEditingController.fromValue(
                                  TextEditingValue(
                                      text: store.state.person.email == null
                                          ? ''
                                          : store.state.person.email,
                                      selection: TextSelection.fromPosition(
                                          TextPosition(
                                        affinity: TextAffinity.downstream,
                                        offset: store.state.person.email == null
                                            ? 0
                                            : store.state.person.email.length,
                                      )))),
...
//                                ),
                              ...
                              onChanged: (str) {
                                print("===onChanged====" + str);
                                store
                                    .dispatch(new ChangePersonEmailAction(str));
                              },
                            ),
                          ),
                                ...
                                child: new TextField(
                                  controller:
                                      new TextEditingController.fromValue(
                                          TextEditingValue(
                                              text: store.state.person.status ==
                                                      null
                                                  ? '离职'
                                                  : store.state.person.status ==
                                                          0
                                                      ? '在职'
                                                      : '离职',
                                              selection:
...
//                                ),
                                  ...
                                  onChanged: (str) {
                                    print("===onChanged====" + str);
                                    store.dispatch(
                                        new ChangePersonTypeAction(str));
                                  },
                                ),
                              ),
                              //new Text("@frogshealth.com",style: new TextStyle(fontSize: 16.0),)
