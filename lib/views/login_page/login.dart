        ...
        body: new ListView(
          children: <Widget>[
            new Column(
              ...
              children: <Widget>[
                new Padding(
                  padding: new EdgeInsets.only(left:30.0,top:120.0,right: 30.0,bottom: 70.0),
                  child: new Image.asset('images/flutter_launcher.png',
                    scale: 1.2,
                  ),
                ),
                      ...
                      new Row(
                          ...
                          children: [
                            new Padding(
                              ...
                              child: new Text('用户名',style: TextStyle(fontSize: 18.0) ,),
                            ),
                            new Expanded(
                              child: new TextField(
                  ...
                  child: new Row(
                      ...
                      children: [
                        new Padding(
                          ...
                          child: new Text('密码',style: TextStyle(fontSize: 18.0) ,),
                        ),
                        new Expanded(
                          child: new TextField(
                ...
                new Container(
                  ...
                  child: new Card(
                    ...
                    child: new FlatButton(
                      ...
                      child: new Text('登录',style: TextStyle(color: Colors.white,fontSize: 16.0),),
                      ),
                      onPressed: (){
                        toCheakData(_userNameController.text,_pwdcontroller.text);
                      },
                    ),
                  ),
                ),
